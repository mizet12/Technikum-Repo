...
<div id="top">
    ...
    <form action="">
        ...
        Powód kontaktu<br>
        <input type="radio" name="powod">Błąd na stronie<br>
        <input type="radio" name="powod">Niemożliwość zakupu<br>
        <input type="radio" name="powod">Nieprawidłowa przesyłka<br>
        <input type="radio" name="powod">Zamówienie anulowane<br>
        <input type="radio" name="powod">inne<br>
        <textarea name="powod" id="" cols="30" rows="10"></textarea><br>
