...
promise.then(
    ...
    (err) => {  // obsługa stanu rejected
        console.log(err.message);
    }
);
/* UWAGA
    Pierwszy argument funkcji then stanowi funkcja obsługi stanu resolved
    (czyli spełnionego promisa). Drugi argument stanowi z kolei funkcja obsługi
    stanu rejected (obietnica odrzucona).
 */
